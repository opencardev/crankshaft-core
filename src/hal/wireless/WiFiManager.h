...
class WiFiManager : public QObject {
 ...
 public:
  ...
  /**
   * @brief Start local WiFi hotspot/AP mode if backend supports it.
   */
  virtual bool startHotspot(const HotspotConfig& config);

  /**
   * @brief Stop local WiFi hotspot/AP mode if backend supports it.
   */
  virtual void stopHotspot();

  /**
   * @brief Get hotspot/AP status if backend supports it.
   */
  virtual HotspotStatus getHotspotStatus() const;
