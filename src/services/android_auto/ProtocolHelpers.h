 ...
 * @param x X coordinate in Android Auto display pixels
 * @param y Y coordinate in Android Auto display pixels
...
aap_protobuf::service::inputsource::message::InputReport createTouchInputReport(
   uint32_t x, uint32_t y, TouchAction action, int pointerId = 0, uint64_t timestamp = 0);
